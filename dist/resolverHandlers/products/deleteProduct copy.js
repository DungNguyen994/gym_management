...
const deleteProductHandler = (_parents, args, { user }) => __awaiter(void 0, void 0, void 0, function* () {
    if (!user)
    ...
    if (role === constant_1.User_Role.member)
        ...
        yield ProductModel_1.ProductModel.findByIdAndDelete(args.id);
        return { data: "Deleted Product Successfully" };
    }
});
exports.deleteProductHandler = deleteProductHandler;
//# sourceMappingURL=deleteProduct%20copy.js.map