    ...
    if (role === constant_1.User_Role.member)
        ...
        if (member) {
            ...
            const newMembeships = (0, immer_1.default)(memberships, (draftState) => {
                const foundMembershipIndex = draftState.findIndex((membership) => (0, dayjs_1.default)(membership.startDate).isSame((0, dayjs_1.default)(), "day"));
...
//# sourceMappingURL=holdMembership%20copy.js.map